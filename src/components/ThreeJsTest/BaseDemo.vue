...
const geometry6 = new Three.CircleGeometry(5);// CircleGeometry：圆形平面


const cube = new Three.Mesh(geometry6, material) // 创建 立方体
...
renderer.setClearColor('#444444', 1) // 设置背景色 、不透明度
